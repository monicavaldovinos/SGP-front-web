        ...
        <div className="modal-content border-0 rounded-4 shadow-sm">
          <div className="modal-body px-5 py-4">
            ...
            <form className="row gx-4 gy-3">
              ...
              <div className="col-md-6">
                <label className="form-label fw-semibold fs-5">Contraseña*</label>
                <input
                  type="text"
                  className="form-control rounded-4"
                  value={form.password}
              ...
              <div className="col-md-6">
                <label className="form-label fw-semibold fs-5">Confirmar contraseña*</label>
                <input
                  type="text"
                  className="form-control rounded-4"
              ...
              {showRole ? (
                <div className="col-md-6">
                  <label className="form-label fw-semibold fs-5">&nbsp;</label>
                  <select
              ...
              <div className="col-12">
                <label className="form-label fw-semibold fs-5">Salario (quincenal)</label>
                <div className="position-relative">
                  <input
                    type="text"
                    className="form-control rounded-4 pe-5"
                  ...
                  />
                  <i
                    className="bi bi-chevron-expand position-absolute"
                    style={{
                      right: "18px",
                      top: "50%",
                      transform: "translateY(-50%)",
