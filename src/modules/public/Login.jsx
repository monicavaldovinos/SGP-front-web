...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Barras extras para profundidad */
            ...
            <form onSubmit={changeSession}>
              ...
              <div className="form-group">
                <div className="form-row-between">
                  ...
                  <Link to="/recovery" className="link-subtle">¿Olvidaste tu contraseña?</Link>
                </div>
                <input
                  type="password"
                  placeholder="••••••••"
